...
def letterPath(l):
    ...
    if l == "A":
        ...
        x = [-0.175, 0.003, 0.185, -0.178, 0.212]
        y = [0.113, 0.264, 0.129, -0.325, -0.325]
    elif l == "3":
        x = [-0.151, 0.013, 0.165, 0.010, 0.182, 0.010, -0.172]
        y = [0.143, 0.274, 0.113, -0.012, -0.163, -0.338, -0.207]
    elif l == "4":
        x = [0.195, -0.209, 0.087, 0.098]
        y = [-0.160, -0.170, 0.261, -0.351]
    elif l == "5":
        x = [0.175, -0.108, -0.155, 0.054, 0.188, 0.020, -0.148]
        y = [0.244, 0.257, -0.029, 0.032, -0.160, -0.351, -0.298]
    elif l == "6":
        x = [0.175, -0.003, -0.165, -0.168, 0.020, 0.185, 0.030, -0.155]
        y = [0.163, 0.261, 0.153, -0.217, -0.335, -0.160, 0.029, -0.113]
    elif l == "7":
        x = [-0.182, 0.195, -0.074]
        y = [0.237, 0.237, -0.341]
    elif l == "8":
        x = [0.007, -0.131, -0.141, 0.145, 0.161, 0.000, -0.138, -0.161, 0.158, 0.151, -0.003]
        y = [0.264, 0.197, 0.072, -0.076, -0.264, -0.338, -0.281, -0.099, 0.059, 0.193, 0.261]
    elif l == "9":
        x = [0.168, 0.024, -0.145, -0.158, 0.037, 0.168, 0.172, 0.040, -0.108, -0.161]
        y = [0.066, -0.103, -0.008, 0.187, 0.261, 0.119, -0.177, -0.335, -0.321, -0.261]
    elif l == "0":
        x = [0.003, -0.138, -0.161, -0.108, 0.010, 0.124, 0.178, 0.172, 0.101, 0.003]
        y = [0.271, 0.177, -0.066, -0.288, -0.338, -0.281, -0.150, 0.116, 0.224, 0.264]
    elif l == ",":
        x = [0.003, -0.038]
        y = [-0.291, -0.451]
    elif l == ".":
